package com.jiranor.boardback.config;
...
import com.jiranor.boardback.filter.JwtAuthencationFilter;
...
public class WebSecurityConfig {
    ...
    protected SecurityFilterChain configure(HttpSecurity httpSecurity) throws Exception{
        ...
        httpSecurity
        .cors(cors->cors
        .configurationSource(corsConfigrationSoruce())
        )
    ...
    @Bean
    protected CorsConfigurationSource corsConfigrationSoruce(){
